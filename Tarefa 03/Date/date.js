...
let htmlResultadoFecha = document.querySelector("#resultadoFecha");
if (htmlResultadoFecha) {
    htmlResultadoFecha.innerHTML += resultadoFecha;
}
const calculaAniversarios = () => {
    let htmlControlFecha = document.querySelector("#selectorFechaAniversario");
    if (htmlControlFecha.value != "") {
        ...
        let htmlResultadoAniversarios = document.querySelector("#resultadoAniversarios");
...
const muestraFechaFormato = () => {
    let htmlFormatoFecha = document.querySelector("#formatoFecha");
...
const muestraHoraFormato = () => {
    let htmlFormatoHora = document.querySelector("#formatoHora");
    console.log(`Seleccionado formato ${htmlFormatoHora.value}`);
    let htmlResultadoFormatoHora = document.querySelector("#resultadoFormatoHora");
